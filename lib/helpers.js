...
console.log(module.exports.objectValueExists(users, "email", "moshelawlor@gmail.com"));
console.log(module.exports.objectValueExists(users, "email", "user2@example.com"));